...
g1 <- plotTwoHeat(allsim.means.m1, "formation", "conversion", "detachment", 0.125, limits=c(0,210), midpoint=0.2, with.legend=FALSE)
g2 <- plotTwoHeat(allsim.means.m1, "formation", "conversion", "detachment", 1, limits=c(0,210), midpoint=0.2)
...
g1 <- plotTwoHeat(allsim.means.m2, "replacement", "conversion", "knockoff", 1e16, limits=c(0,250), midpoint=0.2, with.legend = FALSE)
g2 <- plotTwoHeat(allsim.means.m2, "replacement", "conversion", "knockoff", 1, limits=c(0,250), midpoint=0.2)
grid.arrange(g1, g2, ncol=2, widths=c(40,60)) 
```

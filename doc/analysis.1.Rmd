...
g1 <- plotTwoHeat(allsim.means.m1, "formation", "conversion", "detachment", 0.125, limits=c(0,215), midpoint=0.2, with.legend=FALSE)
g2 <- plotTwoHeat(allsim.means.m1, "formation", "conversion", "detachment", 1, limits=c(0,215), midpoint=0.2)
...
plotTwoHeat(allsim.means.m1, "formation", "detachment", "conversion", 2, limits=c(0,215), midpoint=0.2)
```
...
plotTwoHeat(allsim.means.m2, "replacement", "knockoff", "conversion", 2, limits=c(0,250), midpoint=0.2)
```
